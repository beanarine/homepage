...
<div class="antialiased dark:bg-gray-800 dark:text-gray-100">
  <div class="flex flex-col min-h-screen space-y-12">
    ...
    <section
      class="container flex-1 max-w-3xl px-6 mx-auto space-y-12 xl:max-w-5xl"
    >
      <div class="space-y-6">
        <h2 class="text-3xl font-extrabold dark:text-pink">
          Recent blog posts
        </h2>
        <hr class="text-pink">
          ...
          <li>
            <article>
              <dl>
                ...
                <dd class="text-xs dark:text-text">
              ...
              <div class="space-y-1">
                <h3 class="text-2xl font-bold tracki">
                  <a
                    ...
                    href="#"
                    class="dark:text-gray-50">Hendrerit vulputate eu quo.</a
                  >
                </h3>
                <p class="max-w-full prose dark:text-gray-100">
                  Qui ei agam assum vivendum, ad nostro mediocrem sit, erant
                  sanctus maiestatis vel no. Reque periculis usu at, id mel
                  dicam impetus aliquip. At discere feugiat qui, meliore
                  lucilius persecuti ut pri, vivendo corpora ne sit.
                </p>
            ...
            <article>
              ...
              <div class="space-y-1">
                <h3 class="text-2xl font-bold tracki">
                  ...
                  >
                    Vis te oporteat deterruisset.</a
                  >
                </h3>
                <p class="max-w-full prose dark:text-gray-100">
                  Vero facete sea ne. Ludus saperet scriptorem no usu. Legere
                  intellegam delicatissimi te sit. Vis te oporteat deterruisset.
                </p>
                <div class="flex flex-wrap space-x-3">
                  <a
                    rel="noopener noreferrer"
              ...
              <div class="space-y-1">
                <h3 class="text-2xl font-bold tracki">
                  <a
                    ...
                    href="#"
                    class="dark:text-gray-50"
                    >Mentitum apeirian vim ne, usu illud ridens cu.</a
                  >
                </h3>
                <p class="max-w-full prose dark:text-gray-100">
                  Duo ei paulo decore periculis, sed ex hinc inermis vivendo,
                  meis feugait no mea. Pri magna commodo urbanitas cu, id eos
                  lorem inimicus prodesset. Cu qui vidisse epicurei accusamus.
                </p>
                <div class="flex flex-wrap space-x-3">
                  <a
                    rel="noopener noreferrer"
      ...
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2">
          ...
          <div class="flex flex-col flex-1 p-6">
            ...
            <a
              rel="noopener noreferrer"
              href="#"
              class="text-xs tracki uppercase hover:underline dark:text-violet-400"
              >Convenire</a
            >
        ...
        <div class="flex justify-center">
          <button
            type="button"
            class="px-6 py-3 text-sm hover:underline dark:text-gray-400"
              ...
              <li class="ml-2 space-y-1">
                <div class="flex items-center">
                  <svg
                    ...
                    class="w-4 h-4 mr-2 dark:text-violet-400"
                  >
                    <g
                      fill="none"
                      stroke="currentColor"
                ...
                <p class="ml-6 dark:text-gray-400">
                  Eam eu stet porro fabellas, accumsan prodesset cum ad, has cu
                  odio mundi neglegentur. Cu solum vocent fabellas vix, an
                  dicant constituto duo.
                </p>
              </li>
              <li class="ml-2 space-y-1">
                <div class="flex items-center">
          ...
          <div>
            ...
            <ul class="space-y-4">
              <li class="ml-2 space-y-1">
                ...
                <p class="ml-6 dark:text-gray-400">
                  Cu eum nostrum repudiare, sed dicat doming integre in. Id
                  scripta percipit lucilius pro, te eam libris verterem.
                </p>
              </li>
              <li class="ml-2 space-y-1">
                <div class="flex items-center">
                ...
                <p class="ml-6 dark:text-gray-400">
                  Cut et laoreet vocibus adipisci. Verear utroque perpetua per
                  eu.
                </p>
              </li>
            </ul>
    ...
    <section class="py-6 rounded-md dark:bg-gray-900 dark:text-gray-50">
      <div
        class="container flex flex-col justify-center max-w-3xl p-4 px-6 mx-auto space-y-8 xl:max-w-5xl md:p-10 lg:space-y-0 lg:space-x-12 lg:justify-between lg:flex-row"
      >
        ...
        >
          <div class="flex flex-row">
            ...
            <button
              type="button"
              class="w-2/5 p-3 font-semibold rounded-r-lg sm:w-1/3 dark:bg-violet-400 dark:text-gray-900"
              >Subscribe</button
            >
          </div>
        </div>
    ...
    <footer
      class="container flex flex-col items-center max-w-3xl px-6 mx-auto xl:max-w-5xl"
    >
      <div class="flex mb-3 space-x-4">
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 20 20"
            class="w-6 h-6 fill-current dark:text-violet-400"
          >
            <path
